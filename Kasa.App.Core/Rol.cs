...
public enum Bolum { Panel, KasaSayimi, Haftalik, Aylik, Cariler, Islemler, KrediKartlari, Cekler, Gecmis, Ayarlar, Sorular }
...
public static class SekmeModeli
{
    ...
    public static IReadOnlyList<Bolum> Bolumler(Rol rol)
    {
        var liste = new List<Bolum>
        {
            ...
            Bolum.Sorular,   // her iki rol: izleyici sorar, editör cevaplar
            Bolum.Gecmis,
        };
