...
public partial class IslemlerViewModel
{
    ...
    /// <summary>
    /// Rapordan gelen süzgeci uygular: tarih aralığı + kanal (+ tip). Hızlı zaman çipi, hafta seçimi ve
    /// gelişmiş arama temizlenir; liste yeni süzgeçle yeniden yüklenir.
    /// </summary>
    public Task SuzgecUygulaAsync(IslemSuzgeci s)
    {
        ...
        FiltreBitis = s.Bitis;
        FiltreKanal = s.Kanal;
        AramayiSifirla();   // rapordan iniş tam o rakamı gösterir: gelişmiş arama kalmaz
        SuzgecTip = s.Tip;
        FiltreVurgu();
