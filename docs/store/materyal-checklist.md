...
> **Not — Gizlilik Politikası:** App Store ve Google Play, canlı erişilebilir bir gizlilik politikası URL'i olmadan uygulamayı yayınlamaz. Kasa sunucusu (`kasa.emarglobal.com`) API içindir. Yayından önce bir gizlilik sayfası hazırlanmalı ve bu alanda URL belirtilmelidir.
