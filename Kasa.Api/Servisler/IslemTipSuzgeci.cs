...
public static class IslemTipSuzgeci
{
    ...
    private static readonly string[] Degerler = [Cari, SabitGider, KrediKarti, Nakit];

    /// <summary>Boş (süzgeç yok) ya da bilinen değer değilse Türkçe hata.</summary>
    public static string? Hata(string? tip)
        => string.IsNullOrEmpty(tip) || Degerler.Contains(tip) ? null : "tip Cari, SabitGider, KrediKarti ya da Nakit olmalı.";
