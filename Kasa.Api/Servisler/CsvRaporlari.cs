...
public static class CsvRaporlari
{
    ...
    /// toplam giden, kasa sonucu, kasa devri).
    /// </summary>
    public static byte[] Haftalik(IReadOnlyList<HaftalikOzet> ozetler)
    {
        var csv = new CsvYazici().Baslik("Dönem başı", "Dönem sonu", "Kanal", "Gelen", "Giden", "Sonuç", "Devir");
    ...
    {
        var csv = new CsvYazici().Baslik("Kanal", "Gelen", "Cari giden", "Sabit gider", "Kredi kartı", "Ortak pay", "Ay sonucu");
